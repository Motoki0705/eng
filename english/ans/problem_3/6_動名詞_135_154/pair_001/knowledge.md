# 動名詞 pair_001 - 習得すべき知識

## 📚 このペアで学ぶ文法事項

### 1. 前置詞の目的語となる動名詞 (No. 135)

```
前置詞 + doing「〜すること」
```

**例**: I am interested **in learning** English.
...
#### It is no use doing (No. 139)
```
It is no use doing = There is no use (in) doing
「〜しても無駄だ」
```
...
**例**: **There is no point in** arguing with him.
...
**例**: I **look forward to seeing** you.（お会いできるのを楽しみにしています）
...
**例**: **On arriving** home, I called my mother.（家に着くとすぐに母に電話した）
...
|---------|---------|
| 前置詞の後は動名詞であることを覚えた | ☐ |
| 完了動名詞 having done を覚えた | ☐ |
| It is no use doing の意味を覚えた | ☐ |
