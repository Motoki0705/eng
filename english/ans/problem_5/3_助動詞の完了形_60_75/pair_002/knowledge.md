# 助動詞の完了形 pair_002 - 習得すべき知識（整序英作文）

## 📚 このペアで学ぶ文法事項

### 1. might have done (No. 63)

```
might have done「〜したかもしれない」（may have done よりやや控えめ）
```
...
### 2. ought to have done (No. 65)

```
ought to have done「〜すべきだった（のにしなかった）」
```

**例**: You **ought to have** come earlier.
（もっと早く来るべきだった）
...
### 3. It is necessary/important that S (should) + 原形 (No. 69)

```
It is necessary/important/essential that S (should) + 原形
「Sが〜することは必要だ/重要だ」
```

**例**: It is **necessary that** he **(should) be** there on time.
（彼が時間通りにそこにいることが必要だ）

**例**: It is **important that** everyone **(should) attend** the meeting.
（全員が会議に出席することが重要だ）

**使う形容詞**: necessary, important, essential, vital, urgent, desirable など
...
1. **might have + 過去分詞** の語順
2. **ought to have + 過去分詞** の語順（to を忘れない）
3. **It is + 形容詞 + that + S + (should) + 原形** の構文
4. **cannot ... too ~** の位置関係
...
| 確認項目 | チェック |
|---------|---------|
| might have done の意味がわかる | ☐ |
| ought to have done の語順を覚えた | ☐ |
| It is necessary that S (should) + 原形 を覚えた | ☐ |
| cannot ... too ~ の意味がわかる | ☐ |
| 仮定法の should の省略がわかる | ☐ |
...
| 前のステップ | 現在 | 次のステップ |
|-------------|------|-------------|
| — | 📚 knowledge.md（事前知識） | [問題Aへ →](../../../../tests/problem_5/3_助動詞の完了形_60_75/pair_002/A.md) |
